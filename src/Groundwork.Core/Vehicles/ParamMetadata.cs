...
public sealed record ParamMetadata
{
    ...
    /// <summary>
    /// Gets a value indicating whether changing this parameter requires a reboot.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value indicating whether this parameter's value is volatile (may change without being set).
    /// </summary>
