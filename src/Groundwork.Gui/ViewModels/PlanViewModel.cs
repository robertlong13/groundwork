...
/// <summary>
/// Provides the view model for the Plan page.
/// </summary>
public class PlanViewModel : PageViewModelBase
{
    public override string Title => "Plan";

    // Material Symbols: Location On (filled, weight 400, grade 0, optical size 24)
