...
public enum ParamExclude
{
    ...
    /// <summary>Parameters whose value equals their default.</summary>
    Default = 1,

    /// <summary>Parameters marked volatile in metadata.</summary>
    Volatile = 2,

    /// <summary>Parameters marked read-only in metadata.</summary>
    ReadOnly = 4,
}

/// <summary>
/// Represents a reusable filter for parameter dictionaries by wildcard and metadata flags.
/// </summary>
